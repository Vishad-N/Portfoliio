...
const GitIcon = (props: any) => (
  <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M23.546 10.93L13.067.452a2.975 2.975 0 00-4.204 0C8.214 1.102 7.545 1.769 6.9 2.415L2.83 6.485c-.9.901-.9 2.361 0 3.26l10.48 10.48c1.161 1.161 3.045 1.161 4.204 0l6.032-6.033c1.16-1.161 1.16-3.044 0-4.203zm-10.428 7.39l-2.023-2.023 1.488-1.488 2.023 2.023c.31-.057.632-.016.924.123.633.299.982 1.01.815 1.688-.168.677-.732 1.182-1.416 1.27-.684.088-1.341-.26-1.644-.875-.125-.251-.18-.528-.167-.798zm2.645-3.805a1.854 1.854 0 01-1.028-.316 1.848 1.848 0 01-.659-1.92l1.641-1.641c-.244-.216-.402-.519-.444-.847-.042-.328.046-.66.246-.921.2-.26.502-.435.83-.483.328-.048.665.018.932.183.473.293.722.846.633 1.393-.09.547-.484.99-.997 1.127l-1.637 1.637a1.851 1.851 0 01.483 1.788zm1.092-6.19a1.034 1.034 0 01-1.462 0 1.034 1.034 0 010-1.462 1.034 1.034 0 011.462 0 1.034 1.034 0 010 1.462z" />
  </svg>
);

const PostmanIcon = (props: any) => (
  <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M12 0C5.372 0 0 5.373 0 12s5.372 12 12 12 12-5.373 12-12S18.628 0 12 0zm5.109 15.65c-.092.176-.237.32-.423.419-.186.099-.395.148-.611.148h-5.26c-.328 0-.642-.132-.871-.365a1.233 1.233 0 01-.358-.871v-4.48c0-.327.129-.641.358-.87.229-.228.543-.358.871-.358h5.26c.216 0 .425.05.611.148.186.1.331.243.423.42.091.176.14.373.14.57v3.66c0 .198-.049.395-.14.571zm-2.02-3.142v-1.042h-3.66v3.228h3.66v-1.041a.58.58 0 00-.58-.58h-1.34v-1.066h1.34a.58.58 0 00.58-.58zm2.668.742c-.066.082-.148.15-.24.202-.093.051-.194.085-.3.102-.105.016-.213.013-.318-.009-.104-.022-.204-.061-.295-.116L15.46 12l2.342-1.311c.091-.055.191-.094.295-.116.105-.022.213-.025.318-.009.106.017.207.051.3.102.092.052.174.12.24.202.066.082.115.177.143.279.028.101.037.208.026.314-.01.105-.041.206-.09.298-.049.092-.116.173-.198.24l-1.026.837 1.026.836c.082.067.149.148.198.24.049.092.08.193.09.298.011.106.002.213-.026.314a.833.833 0 01-.143.279z"/>
  </svg>
);

const DockerIcon = (props: any) => (
  <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M11.96 0c-1.35 0-2.65.25-3.86.73-.24.1-.47.2-.68.32-.46-.38-.9-.83-1.25-1.36h.02c1.86-2.58 4.96-4.22 8.4-4.22 5.6 0 10.14 4.54 10.14 10.14 0 5.6-4.54 10.14-10.14 10.14-5.6 0-10.14-4.54-10.14-10.14h2.24c0 4.36 3.54 7.9 7.9 7.9 4.36 0 7.9-3.54 7.9-7.9 0-4.36-3.54-7.9-7.9-7.9-.55 0-1.08.06-1.6.16v2.24h-2.24V2.28c-.1-.02-.18-.04-.28-.04h-.02zm-5.6 15.68h-2.24v2.24h2.24v-2.24zm0-4.48h-2.24v2.24h2.24v-2.24zm-4.48 0H-.36v2.24h2.24v-2.24zm4.48-4.48h-2.24v2.24h2.24V6.72zm-4.48 0H-.36v2.24h2.24V6.72zm4.48-4.48h-2.24v2.24h2.24V2.24zm-4.48 0H-.36v2.24h2.24V2.24zm8.96 13.44H8.6v2.24h2.24v-2.24zm0-4.48H8.6v2.24h2.24v-2.24zm0-4.48H8.6v2.24h2.24V6.72zm0-4.48H8.6v2.24h2.24V2.24z"/>
  </svg>
);

const RedisIcon = (props: any) => (
  <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M15.861 6.845A3.491 3.491 0 0 0 13.91 3.01c-1.849-.406-3.791.535-4.493 2.274-1.229-.443-2.651-.237-3.7.535-.91.682-1.391 1.83-1.246 2.969C3.175 9.07 2.123 10.36 2.008 11.968c-.116 1.625.753 3.197 2.215 3.978.508 1.488 1.65 2.705 3.141 3.32 1.637.674 3.555.518 5.068-.415 1.442.872 3.255.992 4.811.314 1.428-.621 2.47-1.936 2.766-3.486 1.341-.531 2.227-1.884 2.23-3.324.004-1.579-.974-3.053-2.457-3.69-.328-1.464-1.445-2.651-2.921-3.09v.001l-.001-.001Zm-2.831 2.41a1.272 1.272 0 1 1 0 2.544 1.272 1.272 0 0 1 0-2.544Zm-5.32 0a1.272 1.272 0 1 1 0 2.544 1.272 1.272 0 0 1 0-2.544Zm2.66 4.331c1.332 0 2.46.904 2.793 2.146H8.577c.333-1.242 1.46-2.146 2.793-2.146Z" />
  </svg>
);
...
const technologies = [
  ...
  { name: 'Git', x: -500, y: 250, color: '#F05032', icon: GitIcon },
  { name: 'Postman', x: 150, y: 200, color: '#FF6C37', icon: PostmanIcon },
  { name: 'Docker', x: -150, y: 200, color: '#2496ED', icon: DockerIcon },
  { name: 'Redis', x: 500, y: 250, color: '#DC382D', icon: RedisIcon },
];
